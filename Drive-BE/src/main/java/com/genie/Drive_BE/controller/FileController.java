...
import com.genie.Drive_BE.services.FileService;
...
public class FileController {
    ...
    @GetMapping("/trash")
    public ResponseEntity<List<FileEntity>> viewTrashedFiles() {
        return ResponseEntity.ok(fileService.getTrashedFiles());
    }
    ...
    public ResponseEntity<String> toggleStar(@PathVariable Long id) {
        ...
        return ResponseEntity.ok("Star status toggled");
    }

    @GetMapping("/starred")
    public List<FileEntity> getStarredFiles() {
        return fileRepository.findByStarredTrueAndDeletedFalse();
    }
